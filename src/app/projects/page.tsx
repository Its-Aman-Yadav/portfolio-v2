...
function page() {
  return (
    <>
    <div className="min-h-screen overflow-x-hidden overflow-y-hidden bg-black py-12 pt-36">
    <Boxes/>
      <div className="flex flex-wrap overflow-x-hidden overflow-y-hidden justify-center">
        {courseData.projects.map((course) => (
